...
flags.DEFINE_bool("use_phrase", True, "Train phrase or not")
flags.DEFINE_bool("use_emoji_combine", True, "Train emoji combine or not")
...
class Config():
    ...
    def get_config(self, vocab_path, config_filename=None):
        ...
        self.data_utility = DataUtility(vocab_file_in_words=vocab_file_in_words,
                                        ...
                                        vocab_file_emoji=vocab_file_emoji)
        ...
        self.vocab_size_emoji = self.data_utility.emoji_count
