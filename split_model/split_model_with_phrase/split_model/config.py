...
flags.DEFINE_string("data_path", "../resource/train_data_ids/", "Where the training/test data is stored.")
flags.DEFINE_string("vocab_path", "../resource/train_data_ids/", "Where the training/test data is stored.")
